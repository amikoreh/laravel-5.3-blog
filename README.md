...
**Laravel 5-3 example** is a tutorial application. See https://github.com/bestmomo/laravel5-3-example
...
* Administrator : email = admin@test-email.com, password = admin
* Redactor : email = webmaster@test-email.com, password = webmaster
* User : email = Subscriber1@test-email.com, password = subscriber1
* User : email = Subscriber2@test-email.com, password = subscriber2
